...
namespace MagePsycho\DiscountLabel\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME  = 'Discount Label';

    const PRODUCT_URL = 'https://www.magepsycho.com/magento2-product-discount-label.html';

    const MODULE_NAME = 'MagePsycho_DiscountLabel';

    const VERSION_CACHE_KEY = 'mp-discount-label-module-version';
