...
namespace MagePsycho\DiscountLabel\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_DiscountLabel::system/config/form/fieldset/support.phtml';
